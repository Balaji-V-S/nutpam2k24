...
const footer = () => {
  return (
    ...
    <div className='clg-det'>
      ...
      <div className="mail">
        ...
        <h4 className="mail-id">nutpam<span>&#64;</span>sairamit.edu.in</h4>
      </div>
  ...
  <div className='footer-bottom'>
        ...
        <p className='footer-text'>Developed with <span role="img" aria-label="heart">❤️</span> by Nutpam Web Team <br /> &copy; Copyright 2024, All Rights Reserved</p>
      </div>
  </div>
</div>
  )
